...
struct Color {
    ...
    FromYUV(const uint8_t* yuv_ptr)
    {
        ...
        color.r = (uint8_t)CLAMP(temp_R, int16_t(0), int16_t(0xff));
        color.g = (uint8_t)CLAMP(temp_G, int16_t(0), int16_t(0xff));
        color.b = (uint8_t)CLAMP(temp_B, int16_t(0), int16_t(0xff));
        color.a = 0xff;
